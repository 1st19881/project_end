...
-- lEFT JOIN tbl_admin as a ON p.member_id = a.a_id
ORDER BY p.p_id DESC";

$result_pro = mysqli_query($con, $sql);
            ...
            <div class="card_c border h-100 bg-dark" data-aos="zoom-in-right" data-aos-duration="2000">
                ...
                <a data-fancybox="gallery"  href="backend/p_imghome/<?php echo $row_pro['p_img'];?>">
                    <img id="img1" src="backend/p_imghome/<?php echo $row_pro['p_img'];?>" class="card-img-top"
                        alt="Card image cap" height="250px" width="100%" data-aos="zoom-in" data-aos-duration="1500">
                </a>
                <a href="detail.php?p_id=<?php echo $row_pro['p_id'];?>" style="text-decoration:none">
                    <div class="card-body text-left bg-dark">
                        ...
                        <p class="card-text  text-white "><i class="fas fa-th-large"></i> ประเภท:
                        ...
                        <a id="img1" href="detail.php?p_id=<?php echo $row_pro['p_id'];?>" class="btnsub btn"
                            style="text-decoration:none"><i class="fas fa-info-circle"></i> รายละเอียดเพิ่มเติม</a>
                    </div>
