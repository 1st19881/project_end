            ...
            <div class="form-row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h4 class="text-white"><i class="fas fa-search-dollar"></i> : " <?php echo number_format($_GET['min']) ;?> -
                            <?php echo number_format($_GET['max']);?> " บาท</h4>
                    </div>
                </div>
            </div>
        </form>
