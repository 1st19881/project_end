...
<div class="container  ">
    ...
    <div class="col-lg-12 my-4">
        ...
        <div class="box1 p-5">
            ...
            <b>
                <p class="text-dark"><i class="fas fa-dollar-sign"></i> ราคา <?php echo number_format($row["price"]);?> บาท</p>
            </b>
            <hr>
            <div class="d-flex">
        ...
        <div class="box1 card my-4">
            <div class="card-body ">
                <a data-fancybox="gallery" href="../backend/p_imghome/<?php echo $row['p_img'];?>">
                    <img class=" d-block w-100 mw-100" src="../backend/p_imghome/<?php echo $row['p_img'];?>"
                        width="100%" height="auto"></a>
                <br>
                <div class="card-footer">
                    <div class="fb-like" data-href="http://localhost/project/detail.php" data-width=""
