  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
     ...
     <li class="nav-item active">
        <a class="nav-link text-warning  active " href="member.php"><i class="fas fa-home"></i>  หน้าแรก <span class="sr-only"></span></a>
      </li>
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="member.php">ทั้งหมด</a>
        <?php foreach ($result_total as $row1 )  { ?>
        <a class="dropdown-item" href="member.php?act=showbytype&type_id=<?php echo $row1['type_id'];?>">
      ...
      <li class="nav-item active">
        <a class="nav-link text-warning  active " href="member.php">   <span class="sr-only"></span></a>
      </li>
