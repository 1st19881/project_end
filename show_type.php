...
$row_type =mysqli_query($con, $query_dormitory_type) ;
        ...
        <form action="index.php" method="get">
            <div class="form-row">
                ...
                <div class=" col-sm-4 mb-2">
                    <button type="submit"  class="btn4 form-control"><i class="fas fa-search"></i></i></button>
                </div>
            </div>
        </form>
            ...
            <div class="form-row">
                ...
                <div class="col-sm-4">
                    <button type="submit" name="act" value="p" class=" btn4 form-control"><i
                            class="fas fa-search-dollar fa-1x "></i></button>
                </div>
            </div>
        </form>
    </div>
                ...
                <a href="detail.php?p_id=<?php echo $row_type['p_id'];?>" style="text-decoration:none">
                    <div class="card-body text-left bg-dark">
                        ...
                        <p class="card-text text-white"><i class="fas fa-dollar-sign"></i> ราคา: <?php echo  
                         number_format($row_type['price']); ?> บาท / <?php echo $row_type['unit'];?></p>
