...
WHERE p.p_name LIKE '%$q%' or t.type_name  LIKE '%$q%' or p.price  LIKE '%$q%' or p.tag_name  LIKE '%$q%'  or p.unit LIKE '%$q%'
            ...
            <div class="form-row">
                <div class="col-sm-8 mb-2">
                    <input type="search" id="input1" class=" form-control  " name="q" id=""
                        placeholder="ชื่อหอพัก,ราคา,ประเภทหอพัก" value="<?php echo $_GET['q'] ;?>">
                </div>
                <div class=" col-sm-4 mb-2">
                    <button type="submit" class="btn4 form-control"><i class="fas fa-search"> ค้นหา</i></button>
                </div>
            </div>
        </form>
