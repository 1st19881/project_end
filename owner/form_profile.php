                    ...
                    <div class="card-body ">
                        ...
                        <input type="hidden" name="m_img2" value="<?php echo $row['m_img']; ?>">
                            ...
                            <div class="form-group">
                              ...
                              <center>  <img id="blah" class="mt-3" src="../img/upload1.png" alt="your image" width="150px" /></center>
                             <br>
                            </div>
                            <div class="d-flex justify-content-center">
                                ...
                                onclick="window.location='owner.php'"><i class="fas fa-arrow-circle-left"></i>  กลับ</button>
                            </div>
                        </form>
                    </div>
                </div>
