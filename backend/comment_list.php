                ...
                <div class="d-flex flex-column comment-section" id="myGroup">
                    <div class="bg-white p-2 text-dark">
                        <div class="d-flex flex-row user-info"><img class="rounded-circle" src="../m_img/<?php echo $row_c['m_img'] ; ?>" width="75">
                            <div  class="d-flex flex-column justify-content-start ml-2"><span  class="d-block font-weight-bold" >ชื่อ : <span id="input"><?php echo $row_c['m_name']; ?></span>
                            <span class="d-block font-weight-bold">ตอบ : <?php echo $row_c['reply_name']; ?></span>
                            <span class="text-dark font-weight-bold">เวลา : <i class="far fa-clock"></i> <?php echo date("$d"." d-m-Y"." $t"."  H:i:s $s",strtotime($row_c['c_date'])); ?></span>
                            </div>
                        </div>
                        <div class="mt-3">
